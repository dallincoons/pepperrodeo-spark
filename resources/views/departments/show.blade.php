    ...
    <ul class="category create-list-wrapper ">
        <li class="list-item" v-for="department in departments">
            ...
            <div class="remove-item">
                <span v-on:click="removeDepartment(department.id)" class="darker-remove"><i class="fa fa-pencil"></i></span>
                <span v-on:click="removeDepartment(department.id)" class="darker-remove">X</span>
            </div>
