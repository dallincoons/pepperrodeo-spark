<nav class="l-nav">
    <ul>
        ...
        <li class="l-brand">Your recipes & grocery lists in one place.</li>

        <li class="{{ set_active('recipe') }} l-dropdown"><a href="/recipe"><i class="fa fa-cutlery"></i>My Recipes</a>
        ...
        <li class="{{ set_active('grocerylist') }} l-dropdown"><a href="/grocerylist"><i class="fa fa-shopping-cart"></i>My Lists</a>
            <a><i class="fa fa-plus"></i>Create New List</a>
            <a><i class="fa fa-trash"></i>Delete Lists</a>
        </li>
        <li><a><i class="fa fa-user"></i>My Settings</a></li>
    </ul>
</nav>
